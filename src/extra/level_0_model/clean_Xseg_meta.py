...
def _del_keys(data: dict, all_key: typing.List[str], need_key: typing.List[str]):
...
def _get_model_file_name() -> str:
    model_data_name = f"XSeg_data.dat"
...
def do(
    ...
    model_data_name = _get_model_file_name()
...
def cli_mode() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="清理XSeg模型元数据")
